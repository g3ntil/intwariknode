...
import { Code, Smartphone, Camera, BarChart3, Send, CheckCircle2, Phone, Mail, Clock, AlertCircle } from 'lucide-react';
...
export function GetStarted() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error('Failed to submit your project inquiry. Please try again.');
    } finally {
        ...
        <div className="container mx-auto px-6 md:px-12 max-w-5xl relative z-10">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 md:p-10 rounded-3xl border shadow-lg" style={{ borderColor: 'rgba(10, 74, 74, 0.1)' }}>
              ...
              <motion.button
                type="submit"
                className="w-full px-8 py-4 rounded-full inline-flex items-center justify-center gap-2 text-white shadow-lg"
                style={{ backgroundColor: '#0A4A4A', fontWeight: 600 }}
