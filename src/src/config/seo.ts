...
export const pageMetadata = {
  home: {
    ...
    description: 'Leading web design and digital marketing agency in Kigali, Rwanda. Expert website development, e-commerce websites, SEO services, branding, social media management, and custom software development. Professional web design services in Rwanda. Get started today!',
    keywords: `website design rwanda, web development rwanda, digital marketing agency rwanda, web design kigali, website developer kigali, seo services rwanda, branding agency rwanda, affordable website design rwanda, e-commerce website rwanda, custom website rwanda, social media management rwanda, professional web design services, best digital agency rwanda, business website rwanda, online marketing rwanda, ${getAllIndustryKeywords()}`,
  ...
  socialMediaManagement: {
    ...
    description: 'Expert social media management in Rwanda. Content creation, analytics, paid advertising, community management. Grow your brand online. Starting at $999/month.',
    keywords: 'social media management rwanda, digital marketing rwanda, online advertising rwanda, facebook ads rwanda, instagram marketing rwanda, content creation rwanda',
