          ...
          <div className="container mx-auto px-6 md:px-12 lg:px-20 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <motion.div 
                ...
                transition={{ delay: 0.1 }}
              >
                <a href="#privacy" className="text-sm text-gray-500 hover:text-black transition-colors">
                  Privacy
                </a>
                <a href="#terms" className="text-sm text-gray-500 hover:text-black transition-colors">
                  Terms
                </a>
                <a href="#cookies" className="text-sm text-gray-500 hover:text-black transition-colors">
                  Cookies
                </a>
              </motion.div>
            </div>
