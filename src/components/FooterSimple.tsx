...
import { Mail, Instagram, MapPin, ArrowRight, Sparkles, Heart } from 'lucide-react';
          ...
          <div className="container mx-auto px-6 md:px-12 lg:px-20 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <motion.p 
                ...
                viewport={{ once: true }}
              >
                © 2025 INTWARI Knode. Made by intwari knode team
                in Rwanda
              </motion.p>
              ...
              <motion.div 
                ...
                transition={{ delay: 0.1 }}
              >
                <a href="#privacy" className="text-sm text-white/60 hover:text-[#6FB98F] transition-colors">
                  Privacy
                </a>
                <a href="#terms" className="text-sm text-white/60 hover:text-[#6FB98F] transition-colors">
                  Terms
                </a>
                <a href="#cookies" className="text-sm text-white/60 hover:text-[#6FB98F] transition-colors">
                  Cookies
                </a>
              </motion.div>
            </div>
